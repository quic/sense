...
from realtimenet.downstream_tasks.postprocess import PostprocessClassificationOutput, OnePositionRepCounter
from realtimenet.downstream_tasks.postprocess import TwoPositionsRepCounter
...
if __name__ == "__main__":
    ...
    display_ops = [
        ...
        realtimenet.display.DisplayTopKClassificationOutputs(top_k=3, threshold=0),
        realtimenet.display.DisplayRepCounts2(keys=[
            'forearm passes',
            'overhead passes',
            'pokeys',
            'one arm passes',
    ...
    display_results = realtimenet.display.DisplayResults(title=title, display_ops=display_ops, border_size=100)
