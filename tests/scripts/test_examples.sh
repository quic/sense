...
PYTHONPATH=./ python examples/run_calorie_estimation.py $calorie_estimation_args --model_name=StridedInflatedMobileNetV2
PYTHONPATH=./ python examples/run_calorie_estimation.py $calorie_estimation_args --model_name=StridedInflatedMobileNetV2 --model_version=lite
