...
```shell
python scripts/conversion/convert_to_coreml.py --backbone=StridedInflatedEfficientNet --classifier=custom_classifier --path_in=/path/to/your/dataset/ --output_name=sensenet
```
